function [a,b,Q,nsteps,nVec] = LanMPOR(A,r,nsteps)
% [a,b,Q,nsteps,nVec] = LanMPOR(A,r,nsteps)
%
...
% Modified January 2005 by Wei Xu, add restart
%          January 2007 by S. Qiao, improve readability
%
% is A complex?
if (imag(A) ~= 0)
    isComplex = 1;
...
%
            ...
            if ((interNum > 0) & (second == 1))                             % Parastoo: | -> &
